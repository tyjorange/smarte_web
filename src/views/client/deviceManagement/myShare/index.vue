<template>
  <div class="root">
    ...
    <el-row v-for="item in gridData" :key="item.id" class="col_items">
      ...
      <el-col :span="10" class="col24">
        <el-lable class="text-item" effect="dark" placement="right-end" >
          <el-button type="text">共享的人：{{ item.name }}</el-button>
        </el-lable>
        <el-lable class="text-item" effect="dark" placement="right-end" >
          <el-button type="text">共享的权限：{{ item.jurisdiction }}</el-button>
        </el-lable>
